...
Repo Link:
https://hamiltonaaronw@bitbucket.org/hamiltonaaronw/graphics2
Branch:
Midterm

Goals:
To integrate FMOD into animal3D and use it to visualize music

Justification:
This touches three of the suggested themes for the project. Intermediate real-time effect,
intermediate geometry effect, and prototype for the final project.
This project integrates and utilizes an audio framwork that has not been taught to us
in any class, so a lot of it was self exploration. It uses this framework to 
play a song and gather information from it in real time to induce a geometry effect
that simulates a visualization of the music.
